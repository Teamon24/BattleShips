...
class BattleModel : ViewModel() {
    ...
    private val battleShipsTypesProp = emptySimpleMapProperty<Int, Int>().apply(::putInitials)
    ...
    val battleShipsTypes = bind { battleShipsTypesProp }
    ...
    fun put(settings: FleetSettingsAction) {
