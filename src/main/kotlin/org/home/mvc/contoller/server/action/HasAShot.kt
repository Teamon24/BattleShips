...
open class HitAction(hit: Coord, player: String, override val target: String): HasAShot(player, hit) {
    constructor(shotAction: ShotAction): this(shotAction.shot, shotAction.player, shotAction.target)
}

class SinkingAction(hit: Coord, player: String, override val target: String): HasAShot(player, hit) {
    constructor(shotAction: ShotAction): this(shotAction.shot, shotAction.player, shotAction.target)
}
